...
<ThisComponentDoesNotExistAndWillBreakTheBuild />
...
<Tabs>
    <TabItem value="pypi" label="PyPI" default>
        ...
        See the [Model Preparation Guide](../guides/model-preparation/convert-to-openvino.mdx) for details.
        :::
    </TabItem>
    <TabItem value="archive" label="Archive">
        ...
        2. Follow the [Archive Installation instructions](https://docs.openvino.ai/2026/get-started/install-openvino/install-openvino-genai.html#archive-installation).
    </TabItem>
    <TabItem value="npm" label="npm">
        ```bash
        npm install openvino-genai-node
        ```
        See the [Node.js Bindings](../bindings/node-js.md) for more information.
    </TabItem>
    <TabItem value="brew" label="Brew">
       ```bash
       brew install openvino-genai
       ```
    </TabItem>
</Tabs>


Refer to the [Install Guide](https://docs.openvino.ai/2026/get-started/install-openvino.html) for detailed instructions.
...
Refer to the [OpenVINO System Requirements](https://docs.openvino.ai/2026/about-openvino/release-notes-openvino/system-requirements.html) for more details.
