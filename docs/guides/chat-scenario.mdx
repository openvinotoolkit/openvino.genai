...
Refer to the [How It Works](../concepts/how-it-works.md) for more information about KV-cache.
...
[`ChatHistory`](https://docs.openvino.ai/2026/api/genai_api/_autosummary/openvino_genai.ChatHistory.html) stores conversation messages and optional metadata for chat templates.
