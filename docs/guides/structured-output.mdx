...
OpenVINO GenAI JavaScript bindings also support the Structured Output feature. Check [JS samples](../samples/js/text_generation#7-structured-output-sample-structured_output_sample) for usage examples.
