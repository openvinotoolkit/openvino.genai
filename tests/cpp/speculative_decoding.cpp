    ...
    public:
        ...
        ov::genai::GenerationHandle add_request(uint64_t request_id, const ov::Tensor& input_ids) {
            ...
            ov::genai::SequenceGroup::Ptr sequence_group =
                std::make_shared<ov::genai::SequenceGroup>(request_id, input_ids, sampling_params, 32);
            ...
            return std::make_shared<ov::genai::GenerationHandleImpl>(sequence_group->get_generation_stream(),
                                                                     sampling_params);
        };
    };
...
TEST_F(CBForSDTest, update_empty_sequence_by_not_empty__two_sequence) {
    ...
    ov::genai::GeneratedSequences candidate{{0, ov::genai::GeneratedSequence(tokens_0, log_probs_0)},
