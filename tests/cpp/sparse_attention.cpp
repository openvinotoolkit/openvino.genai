...
const std::vector<SparseAttentionBlockSkipperTestStruct> SKIPPER_TEST_CASES = {
    ...
    {158,
     ...
     32,
     {},
     "five_block_prompt_sparse_prefill_phase_early_multi_block_chunk_multi_block_dense_phase"},
    ...
    {190,
     ...
     32,
     {1},
     "six_block_prompt_sparse_prefill_phase_with_skips_multi_block_chunk_multi_block_dense_phase"},
    ...
    {158,
     ...
     32,
     {1},
     "five_block_prompt_sparse_prefill_phase_with_multi_block_dense_starting_in_same_block"},
    ...
    {300,
     ...
     64,
     {3, 4},
     "ten_block_prompt_sparse_prefill_phase_with_skips_larger_start_recent_areas_inverted"},
    {158,
     100,
     5,
     50,
     ...
     96,
     {},
     "five_block_prompt_sparse_prefill_phase_with_multi_block_dense_starting_in_same_block_larget_start_recent_areas"},
    {158,
     45,
     40,
     113,
     ...
     96,
     {},
     "five_block_prompt_dense_prefill_phase_start_crossing_block_borders_larget_start_recent_areas"},
};

class SparseAttentionBlockSkipperReferenceTest
    : public ::testing::Test,
      public ::testing::WithParamInterface<SparseAttentionBlockSkipperTestStruct> {
protected:
...
TEST_P(SparseAttentionBlockSkipperReferenceTest, CorrectBlocksAreSkipped) {
    auto test_struct = GetParam();
    auto skipper = TriShapeSparseAttentionTokenSkipper(BLOCK_SIZE,
                                                       test_struct.num_last_dense_tokens_in_prefill,
                                                       test_struct.num_retained_start_tokens_in_cache,
                                                       test_struct.num_retained_recent_tokens_in_cache);
...
INSTANTIATE_TEST_SUITE_P(VariousSequenceGroupStates,
                         SparseAttentionBlockSkipperReferenceTest,
                         ::testing::ValuesIn(SKIPPER_TEST_CASES),
                         [](const testing::TestParamInfo<SparseAttentionBlockSkipperReferenceTest::ParamType>& info) {
