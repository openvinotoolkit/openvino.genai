...
from utils.generation_config import (
    ...
    get_multinomial_max_and_min_token,
...
@pytest.mark.parametrize(
    "generation_config",
    [
        {"max_new_tokens": 50, "min_new_tokens": 15, "stop_strings": {"anag"}, "include_stop_str_in_output": True},
        {
            "max_new_tokens": 50,
            "min_new_tokens": 1,
        ...
        {"max_new_tokens": 30, "stop_strings": {"machines"}, "include_stop_str_in_output": False},
        {"max_new_tokens": 30, "stop_strings": {"machines"}, "include_stop_str_in_output": True},
        {"max_new_tokens": 30, "stop_strings": {"machines", "manage"}, "include_stop_str_in_output": False},
        {"max_new_tokens": 30, "stop_strings": {"machines", "manage"}, "include_stop_str_in_output": True},
    ],
    ids=[
        "single_stop_string",
...
def test_stop_strings_facebook_opt(
    model_facebook_opt_125m: OVConvertedModelSchema, generation_config: GenerationConfig, pipeline_type
):
...
def test_stop_strings_tinyllama(
    model_tinyllama_1_1b_chat: OVConvertedModelSchema, generation_config: GenerationConfig, pipeline_type
):
    prompts = ["What is OpenVINO?"]
...
def test_multinomial_sampling_against_reference(
    model_facebook_opt_125m: OVConvertedModelSchema, test_struct: RandomSamplingTestStruct
):
    ...
    run_ov_pipeline(
        models_path=model_facebook_opt_125m.models_path, prompt=prompts, generation_config=generation_config
    )
