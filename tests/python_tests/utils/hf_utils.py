...
def ov_generation_config_to_hf(
...
def run_hugging_face(
    ...
    if type(generation_configs) is list:
        ...
        for prompt, generation_config in zip(prompts, generation_configs):
            hf_generation_config = ov_generation_config_to_hf(opt_model.generation_config, generation_config)
            inputs = {}
        ...
        input_ids, attention_mask = inputs['input_ids'], inputs['attention_mask']
        hf_generation_config = ov_generation_config_to_hf(opt_model.generation_config, generation_configs)
...
def download_and_convert_model(model_id: str,
    ...
    return models_path, opt_model, hf_tokenizer
