...
def download_and_convert_model_class(
    ...
    **tokenizer_kwargs,
    ...
    manager = AtomicDownloadManager(models_path, marker_name=".convert_complete")
...
def download_gguf_model(
    ...
    manager = AtomicDownloadManager(models_path_gguf, marker_name=".gguf_download_complete")
