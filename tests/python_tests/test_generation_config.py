...
from openvino_genai import GenerationConfig, ReasoningConfig, StructuredOutputConfig
import json
import math
import os
import pytest
...
configs = [
    ...
    dict(max_new_tokens=1, reasoning_config=ReasoningConfig(budget=10, start_token_id=151667, end_token_id=151668)),
    dict(max_new_tokens=1, reasoning_config=ReasoningConfig(budget=-1)),
]
