...
class TestVisualLanguageChat:
    ...
    def test_sample_visual_language_chat_images(
        self, convert_model, download_test_content, generate_test_content, questions
    ):
        # Test Python sample
        py_script = SAMPLES_PY_DIR / "visual_language_chat/visual_language_chat.py"
    ...
    def test_sample_visual_language_chat_prompt_lookup(self, convert_model, download_test_content, questions):
        ...
        # Compare results
        assert py_result.stdout == py_result_lookup.stdout, "Results should match"
