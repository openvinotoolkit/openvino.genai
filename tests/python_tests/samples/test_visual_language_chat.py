...
class TestVisualLanguageChat:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param("llava-v1.6-mistral-7b-hf", "monalisa.jpg", 'Who drew this painting?\nWhen did the painter live?', marks=pytest.mark.xfail(reason="Export failure: https://github.com/huggingface/optimum-intel/issues/1398", raises=CalledProcessError)),
