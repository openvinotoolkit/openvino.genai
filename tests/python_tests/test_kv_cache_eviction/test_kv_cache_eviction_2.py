...
def test_kvcrush_vs_snapkv_baseline_longbench(subset):
    ...
    _log(
        ...
        f"start_size={KVCRUSH_SNAPKV_BASELINE_CONFIG.start_size} recent_size={KVCRUSH_SNAPKV_BASELINE_CONFIG.recent_size} "
        f"max_cache_size={KVCRUSH_SNAPKV_BASELINE_CONFIG.max_cache_size} snapkv_window_size={KVCRUSH_SNAPKV_BASELINE_CONFIG.snapkv_window_size} "
    ...
    _log(
        "KVCrush config: "
        f"start_size={config.start_size} recent_size={config.recent_size} max_cache_size={config.max_cache_size} "
