...
def test_cache_optimized_generation_is_similar_to_unoptimized(test_struct, apply_rotation, use_sparse_attention):
    ...
    if scheduler_config_opt.use_cache_eviction and scheduler_config_opt.cache_eviction_config is not None:
        ...
        _log(
            ...
            f"start_size={cfg.start_size} recent_size={cfg.recent_size} max_cache_size={cfg.max_cache_size} "
...
def test_optimized_generation_longbench(test_struct):
    ...
    _log(
        ...
        f"start_size={LONGBENCH_CACHE_EVICTION_CONFIG.start_size} recent_size={LONGBENCH_CACHE_EVICTION_CONFIG.recent_size} "
        f"max_cache_size={LONGBENCH_CACHE_EVICTION_CONFIG.max_cache_size} aggregation_mode={LONGBENCH_CACHE_EVICTION_CONFIG.aggregation_mode}"
    )
