...
<!-- SECTION-END: run_checker -->

<!-- SECTION-START: interpret_results -->
...
<!-- SECTION-END: interpret_results -->

<!-- SECTION-START: report_and_security -->
...
<!-- SECTION-END: report_and_security -->
