...
## Checklist:
- [ ] This PR follows GenAI Contributing guidelines. <!-- Always follow [https://github.com/openvinotoolkit/openvino.genai?tab=contributing-ov-file](https://github.com/openvinotoolkit/openvino.genai?tab=contributing-ov-file#header). If there are deviations, explain what and why. -->
