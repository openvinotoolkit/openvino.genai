...
For example, in case of `LLMPipeline` or `VLMPipeline` is created and PageAttention transformation was applied successfully, after pipeline initialization and reading the model, the next message will be printed to the console.
```sh title="Output:"
