...
OpenVINO GenAI JavaScript bindings also support the Structured Output feature. Check [JS samples directory](https://github.com/openvinotoolkit/openvino.genai/tree/master/samples/js/text_generation) for usage examples.
