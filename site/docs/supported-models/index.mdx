...
3. If input frame count is not divisible by mm_local_num_frames in config.json, extra frames are dropped (e.g., 10 frames with mm_local_num_frames=4 drops the last 2 frames).
