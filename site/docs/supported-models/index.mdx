...
Gemma 4 implementation supports text and image inputs only. Video input is not supported at the moment.
...
#### Mistral3 {#mistral3-notes}

The model requires `transformers>=4.50` for the export with `optimum-cli`.
:::
