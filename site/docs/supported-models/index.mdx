...
Gemma 4 supports text, image, video, and audio inputs. Audio tensors must contain mono 16 kHz float32 PCM samples. The E2B and E4B models use mel-spectrogram features, while the 12B model uses the Gemma4 Unified raw-waveform frontend.
