...
int main(int argc, char* argv[]) {
    ...
    // Models supporting audios take 'ov::genai::audios' as mono float32 PCM at 16 kHz
    // pipe.generate(prompt, ov::genai::audios(std::vector<ov::Tensor>{audio}), ov::genai::max_new_tokens(100));
}
`}
</CodeBlock>
