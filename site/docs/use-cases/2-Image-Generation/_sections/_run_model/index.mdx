...
- Text-to-Image - creating images from text prompts.
- Image-to-Image - modifying existing images based on prompts.
- Inpainting - selectively replacing portions of images using masks.
