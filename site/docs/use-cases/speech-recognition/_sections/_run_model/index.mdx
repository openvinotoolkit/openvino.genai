...
OpenVINO GenAI introduces the [`ASRPipeline`](https://docs.openvino.ai/2026/api/genai_api/_autosummary/openvino_genai.ASRPipeline.html) pipeline for automatic speech recognition models (ASR).
