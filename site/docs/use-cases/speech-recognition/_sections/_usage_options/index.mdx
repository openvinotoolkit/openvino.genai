...
Because Qwen3-ASR and its forced aligner are distributed separately, export them to two independent directories. Install `qwen-asr` before exporting:

```sh
pip install qwen-asr

# Export Qwen3-ASR.
optimum-cli export openvino --model Qwen/Qwen3-ASR-0.6B qwen3-asr-ov

# Export its companion aligner to a separate directory.
optimum-cli export openvino --model Qwen/Qwen3-ForcedAligner-0.6B qwen3-forced-aligner-ov
```
