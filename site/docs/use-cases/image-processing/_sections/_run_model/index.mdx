...
OpenVINO GenAI introduces the [`VLMPipeline`](https://docs.openvino.ai/2026/api/genai_api/_autosummary/openvino_genai.VLMPipeline.html) pipeline for inference of multimodal text-generation Vision Language Models (VLMs).
