...
import CodeExampleCpp from '@site/docs/use-cases/text-reranking/_sections/_run_model/_code_example_cpp.mdx';
import CodeExamplePython from '@site/docs/use-cases/text-reranking/_sections/_run_model/_code_example_python.mdx';

export const TextReranking = () => (
    <UseCaseCard>
        <UseCaseCard.Title>Text Reranking for RAG</UseCaseCard.Title>
        ...
        <UseCaseCard.Actions>
            <Button label="Explore Use Case" link="docs/use-cases/text-reranking" variant="primary" />
