...
TasksManager._SUPPORTED_MODEL_TYPE["stablelm_epoch"] = (
    TasksManager._SUPPORTED_MODEL_TYPE["stablelm"]
)
TasksManager._SUPPORTED_MODEL_TYPE["stablelm-epoch"] = (
    TasksManager._SUPPORTED_MODEL_TYPE["stablelm"]
)
TasksManager._SUPPORTED_MODEL_TYPE["stablelm2"] = TasksManager._SUPPORTED_MODEL_TYPE[
    "stablelm"
]
