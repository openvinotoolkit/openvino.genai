...
class StableDiffusionHook:
    def __init__(self):
        ...
        self.text_encoder_iter_count = 0
        self.unet_iter_count = 0
        self.vae_decoder_iter_count = 0

    def get_text_encoder_latency(self):
        return (self.text_encoder_time / self.text_encoder_iter_count) * 1000 if self.text_encoder_iter_count > 0 else 0
    ...
    def get_vae_decoder_latency(self):
        return (self.vae_decoder_time / self.vae_decoder_iter_count) * 1000 if self.vae_decoder_iter_count > 0 else 0

    def get_text_encoder_iter_count(self):
        return self.text_encoder_iter_count

    def get_unet_iter_count(self):
        return self.unet_iter_count

    def get_vae_decoder_iter_count(self):
        return self.vae_decoder_iter_count
    ...
    def new_text_encoder(self, pipe):
        ...
        def my_text_encoder(inputs, shared_memory=True, **kwargs):
            ...
            self.text_encoder_iter_count += 1
            return r
