...
def get_model_precision(model_name_list):
    precision_list = [
        ...
        'OV_FP32-INT8', 'OV_FP16-INT8', 'OV_FP32-INT8_ASYM', 'OV_FP16-INT8_ASYM', 'PT_FP32-INT8', 'PT_FP16-INT8', 'PT_FP32-INT8_ASYM', 'PT_FP16-INT8_ASYM', 'GPTQ_INT4-FP32', 'GPTQ_INT4-FP16', 'INT4',
