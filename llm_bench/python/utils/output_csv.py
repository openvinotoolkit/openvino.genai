...
def output_comments(result, use_case, writer):
    ...
    if use_case == 'text_gen' or use_case == 'code_gen':
        ...
        comment_list.append('2nd_avg_latency: Text/Code generation models: other tokens (exclude first token) avarage time')
        comment_list.append('1st_infer_latency: Text/Code generation models: fisrt inference time')
        comment_list.append('2nd_infer_avg_latency: Text/Code generation models: other inferences (exclude first inference) avarage time')
        ...
        comment_list.append('1st_latency: Inference lantency of text_encoder')
        comment_list.append('2nd_avg_latency: Avarage inference latency of unet and vae_decoder')
        ...
        comment_list.append("infer_count: Tex2Image models' Inference(or Sampling) step size")
        comment_list.append('1st_latency: First inference lantency of unet')
        comment_list.append('2nd_avg_latency: Avarage inference lantency of unet(exclude first infer time) and vqvae')
        comment_list.append('1st_infer_latency: Same as 1st_latency')
        comment_list.append('2nd_infer_avg_latency: Same as 2nd_avg_latency')
