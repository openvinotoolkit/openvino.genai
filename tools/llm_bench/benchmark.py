...
def get_argprser():
    ...
    parser.add_argument(
        "--height", type=int, required=False, help="Generated image height. Applicable only for Image Generation."
    )
    parser.add_argument(
        "--width", type=int, required=False, help="Generated image width. Applicable only for Image Generation."
    )
    parser.add_argument(
        "--static_reshape",
        action="store_true",
    ...
    parser.add_argument(
        "--num_frames", type=int, required=False, help="Generated guidance scale. Applicable only for Video Generation."
    )
