...
def run_text_embeddings_optimum(
    input_text, num, model, tokenizer, args, iter_data_list, prompt_index, bench_hook, proc_id, mem_consumption
):
    ...
    if args["subsequent"] is False:
        for num in range(num_iters + 1):
            for idx, input_text in enumerate(text_list):
                ...
                text_emb_fn(
                    input_text, num, model, tokenizer, args, iter_data_list, p_idx, bench_hook, proc_id, mem_consumption
                )
