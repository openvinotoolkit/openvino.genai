...
def run_text_generation_genai_with_stream(input_text, num, model, tokenizer, args, iter_data_list, md5_list,
    ...
    print(f"min_new_tokens = {gen_config.min_new_tokens}")
    print(f"stop_token_ids = {gen_config.stop_token_ids}")
    print(f"stop_strings = {gen_config.stop_strings}")
    print(f"num_beam_groups = {gen_config.num_beam_groups}")
    print(f"num_beams = {gen_config.num_beams}")
    print(f"diversity_penalty = {gen_config.diversity_penalty}")
    print(f"length_penalty = {gen_config.length_penalty}")
    ...
    print(f"presence_penalty = {gen_config.presence_penalty}")
    print(f"frequency_penalty = {gen_config.frequency_penalty}")
