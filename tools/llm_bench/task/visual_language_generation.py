...
def run_visual_language_generation_optimum(
    ...
    iter_data = gen_output_data.gen_iterate_data(
        ...
        out_size=num_tokens,
        output_repr=gen_output_data.text_output_repr(generated_text[0], processor["tokenizer"]),
...
def run_visual_language_generation_genai(
    ...
    iter_data = gen_output_data.gen_iterate_data(
        ...
        output_repr=gen_output_data.text_output_repr(generated_text[0], model.get_tokenizer()),
        gen_time=generation_time,
        latency=per_token_time,
        res_md5=result_md5_list,
        prompt_idx=prompt_index,
