...
- `output_repr`: **Derived** human-readable **output** summary of a single item, symmetric with `prompt_repr`: generated text as a word count (`text:<N>w`), media as dimensions (`image:512x512` — super-resolution upscaled output, `audio:48000smp@22050Hz`, `video:640x480@16f`).
