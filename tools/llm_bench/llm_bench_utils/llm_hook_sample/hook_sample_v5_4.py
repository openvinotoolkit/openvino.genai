...
# Copied from https://github.com/huggingface/transformers/blob/v5.13.0/src/transformers/generation/utils.py#L2760
def new_sample(
    self,
    input_ids: torch.LongTensor,
    ...
    **model_kwargs,
    ...
    # Realign pad_token_id with input_ids to avoid cross-device ops on multimodal / device_map="auto" models.
    # Introduced in transformers v5.11.0; safe no-op on earlier versions where devices already match.
