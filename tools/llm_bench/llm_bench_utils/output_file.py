...
def save_video_file(frames, video_save_name, args):
...
def get_file_name(batch_size, model_name, model_precision, prompt_idx, iteration, batchsize_idx, proc_id, suffix):
...
def output_gen_text(generated_text, args, model_precision, prompt_idx, iteration, batchsize_idx, proc_id):
    text_file_name = get_file_name(args['batch_size'], args['model_name'], model_precision, prompt_idx,
                                   iteration, batchsize_idx, proc_id=proc_id, suffix='_output.txt')
...
def output_gen_image(img, args, prompt_idx, iteration, batchsize_idx, proc_id, suffix):
    img_save_name = get_file_name(args['batch_size'], args['model_name'], model_precision=None, prompt_idx=prompt_idx,
                                  iteration=iteration, batchsize_idx=batchsize_idx, proc_id=proc_id, suffix=f'_output{suffix}')
...
def output_gen_audio(audio, args, prompt_idx, iteration, batchsize_idx, proc_id, suffix):
    audio_save_name = get_file_name(args['batch_size'], args['model_name'], model_precision=None, prompt_idx=prompt_idx,
                                    iteration=iteration, batchsize_idx=batchsize_idx, proc_id=proc_id, suffix=f'_output{suffix}')
...
def output_gen_video(video, args, prompt_idx, iteration, batchsize_idx, proc_id, suffix):
    video_save_name = get_file_name(args['batch_size'], args['model_name'], model_precision=None, prompt_idx=prompt_idx,
                                    iteration=iteration, batchsize_idx=batchsize_idx, proc_id=proc_id, suffix=f'_output{suffix}')
