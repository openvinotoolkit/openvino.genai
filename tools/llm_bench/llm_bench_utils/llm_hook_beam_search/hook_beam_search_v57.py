...
def initialize_beam_search(generation_config, input_ids):
...
# Transformers version: v4.57-release 47b0e478f324b54f177ea7998a0791870fdd0324
# Copied from https://github.com/huggingface/transformers/blob/47b0e478f324b54f177ea7998a0791870fdd0324/src/transformers/generation/utils.py#L3111
# Add the function of collecting latency
def new_beam_search_v57(
    self,
