...
def new_greedy_search(
    ...
    **model_kwargs,
    ...
    while self._has_unfinished_sequences(this_peer_finished, synced_gpus, device=input_ids.device):
        ...
        tm_sample_list.append(time.perf_counter() - tic_sample)
...
class GreedySearchHook:
    def __init__(self):
        ...
        tm_infer_list.clear()
        global tm_sample_list
        tm_sample_list.clear()
    ...
    def clear_time_sample_list(self):
        """Clear the sample time list."""
        global tm_sample_list
        tm_sample_list.clear()

    def get_time_sample_list(self):
        """Return the sample time list."""
        global tm_sample_list
        return tm_sample_list
    ...
    def new_forward(self, model):
        ...
        if trans_version >= version.parse("5.4.0"):
