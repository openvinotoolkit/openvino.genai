...
# TinyLlama uses strict Q4_K decoding to compare against the source weights. All other models
# use the production weight path, including its lossy u4 requantization for Q4_K weights.
#
