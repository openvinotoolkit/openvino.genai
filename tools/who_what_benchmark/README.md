...
> **NOTE**: HF, Optimum, and OpenVINO GenAI text generation use the model sampling configuration by default. Use `--do-sample` to enable sampling explicitly or `--greedy` to disable it.<br>
