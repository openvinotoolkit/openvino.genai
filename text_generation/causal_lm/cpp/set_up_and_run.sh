...
mkdir ./ov/
curl https://storage.openvinotoolkit.org/repositories/openvino/packages/nightly/2024.0.0-14032-6bd90554401/l_openvino_toolkit_ubuntu20_2024.0.0.dev20240117_x86_64.tgzz | tar --directory ./ov/ --strip-components 1 -xz
