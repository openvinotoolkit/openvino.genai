...
- **Run Command:**
  ...
  Example:
  ```bash
  ./image2video ltx_video_ov_i2v/FP32 photo.jpg "A golden retriever in a sunlit bedroom slowly stands up, stretches its front paws forward, yawns wide showing pink tongue, then turns its head to look at the camera"
  ```
