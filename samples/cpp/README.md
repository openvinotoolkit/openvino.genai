...
If `chat\_sample.exe` fails to start despite a successful build, it may be unable to locate the OpenVINO or TBB libraries. This is common when building with Visual Studio.
...
copy <path\_to\_venv>\\Lib\\site-packages\\openvino\\libs\\\*.dll <path\_to\_build>\\Release\\
