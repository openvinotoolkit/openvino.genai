...
int32_t main(int32_t argc, char* argv[]) try {
    ...
    // export/import with a pipeline.export_model() method
    {
    ...
    // export/import with dedicated model components
    {
        ...
        auto imported_pipe = ov::genai::Text2ImagePipeline::stable_diffusion_xl(
            ...
            ov::genai::CLIPTextModel(root_dir / "text_encoder",
                                     device,
                                     ov::genai::blob_path(blob_path / "text_encoder")),
