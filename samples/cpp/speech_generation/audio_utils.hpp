 ...
 *
 * @param waveform_ptr Pointer to the array of float samples representing the audio waveform, interleaved for
 *                     multi-channel audio
 * @param waveform_size The number of samples per channel in the waveform array
