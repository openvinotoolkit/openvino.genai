...
def main():
    ...
    print(pipe.generate(args.prompt, do_sample=False, max_new_tokens=100, adapters=openvino_genai.AdapterConfig(adapter, 0.75)))

    print("\n-----------------------------")
    print("Generate without LoRA adapter:")
    print(pipe.generate(args.prompt, do_sample=False, max_new_tokens=100, adapters=openvino_genai.AdapterConfig()))
