import BasicGenerationConfiguration from '../../../_shared/_basic_generation_configuration.mdx';
import ChatScenario from '../../../_shared/_chat_scenario.mdx';
import GenerationConfigurationWorkflow from '../../../_shared/_generation_configuration_workflow.mdx';
import Streaming from '../../../_shared/_streaming.mdx';
...
Similar to [text generation](../../../text-generation/index.mdx#use-different-generation-parameters), VLM pipelines support various generation parameters to control the text output.
...
Refer to the [LoRA Adapters](../../../../guides/lora-adapters.mdx) guide for more details on working with LoRA adapters.
