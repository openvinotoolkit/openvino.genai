...
void init_clip_text_model(py::module_& m) {
    ...
    clip_text_model.def("get_config", &ov::genai::CLIPTextModel::get_config)
        ...
        .def("infer", &ov::genai::CLIPTextModel::infer, py::arg("pos_prompt"), py::arg("neg_prompt"), py::arg("do_classifier_free_guidance"), py::arg("raw_metrics"))
...
void init_clip_text_model_with_projection(py::module_& m) {
    ...
    clip_text_model_with_projection.def("reshape", &ov::genai::CLIPTextModelWithProjection::reshape, py::arg("batch_size"))
        .def("infer", &ov::genai::CLIPTextModelWithProjection::infer, py::arg("pos_prompt"), py::arg("neg_prompt"), py::arg("do_classifier_free_guidance"), py::arg("raw_metrics"))
...
void init_t5_encoder_model(py::module_& m) {
    auto t5_encoder_model = py::class_<ov::genai::T5EncoderModel>(m, "T5EncoderModel", "T5EncoderModel class.")
        ...
        .def("infer", &ov::genai::T5EncoderModel::infer, py::arg("pos_prompt"), py::arg("neg_prompt"), py::arg("do_classifier_free_guidance"), py::arg("max_sequence_length"), py::arg("raw_metrics"))
...
void init_unet2d_condition_model(py::module_& m) {
    ...
    unet2d_condition_model.def("get_config", &ov::genai::UNet2DConditionModel::get_config)
        ...
        .def("infer", &ov::genai::UNet2DConditionModel::infer, py::arg("sample"), py::arg("timestep"), py::arg("raw_metrics"))
...
void init_sd3_transformer_2d_model(py::module_& m) {
    ...
    sd3_transformer_2d_model.def("get_config", &ov::genai::SD3Transformer2DModel::get_config)
        ...
        .def("infer", &ov::genai::SD3Transformer2DModel::infer, py::arg("sample"), py::arg("timestep"), py::arg("raw_metrics"))
...
void init_flux_transformer_2d_model(py::module_& m) {
    ...
    flux_transformer_2d_model.def("get_config", &ov::genai::FluxTransformer2DModel::get_config)
        ...
        .def("infer", &ov::genai::FluxTransformer2DModel::infer, py::arg("sample"), py::arg("timestep"), py::arg("raw_metrics"))
...
void init_autoencoder_kl(py::module_& m) {
    ...
    autoencoder_kl.def("reshape", &ov::genai::AutoencoderKL::reshape, py::arg("batch_size"), py::arg("height"), py::arg("width"))
        ...
        .def("decode", &ov::genai::AutoencoderKL::decode, py::arg("latent"), py::arg("raw_metrics"))
