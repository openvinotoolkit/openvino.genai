...
void init_clip_text_model(py::module_& m) {
    auto clip_text_model =
        py::class_<ov::genai::CLIPTextModel>(m, "CLIPTextModel", "CLIPTextModel class.")
    ...
    py::class_<ov::genai::CLIPTextModel::Config>(clip_text_model,
                                                 "Config",
...
void init_clip_text_model_with_projection(py::module_& m) {
    py::class_<ov::genai::CLIPTextModelWithProjection, ov::genai::CLIPTextModel>(m,
...
void init_unet2d_condition_model(py::module_& m) {
    ...
    py::class_<ov::genai::UNet2DConditionModel::Config>(unet2d_condition_model,
                                                        "Config",
...
void init_sd3_transformer_2d_model(py::module_& m) {
    ...
    py::class_<ov::genai::SD3Transformer2DModel::Config>(sd3_transformer_2d_model,
                                                         "Config",
...
void init_autoencoder_kl(py::module_& m) {
    auto autoencoder_kl =
        py::class_<ov::genai::AutoencoderKL>(m, "AutoencoderKL", "AutoencoderKL class.")
            ...
            .def(py::init([](const std::filesystem::path& vae_encoder_path,
                             ...
                             const std::string& device,
                             const py::kwargs& kwargs) {
                     return std::make_unique<ov::genai::AutoencoderKL>(vae_encoder_path,
                                                                       vae_decoder_path,
                                                                       device,
                                                                       pyutils::kwargs_to_any_map(kwargs));
                 }),
    ...
    py::class_<ov::genai::AutoencoderKL::Config>(autoencoder_kl,
                                                 "Config",
