...
void init_clip_text_model(py::module_& m) {
    auto clip_text_model = py::class_<ov::genai::CLIPTextModel>(m, "CLIPTextModel", "CLIPTextModel class.")
                               .def(
                                   py::init([](const std::filesystem::path& root_dir) {
            ...
            root_dir (os.PathLike): Model root directory.
                               ...
                               .def(
                                   py::init([](const std::filesystem::path& root_dir,
                                       ...
                                       ScopedVar env_manager(pyutils::ov_tokenizers_module_path());
                                       return std::make_unique<ov::genai::CLIPTextModel>(
                                           root_dir,
                                           device,
            ...
            kwargs: Device properties.
                               ...
                               .def(
                                   py::init([](const ov::genai::CLIPTextModel& model) {
    ...
    py::class_<ov::genai::CLIPTextModel::Config>(
        clip_text_model,
        "Config",
        "This class is used for storing CLIPTextModel config."
    )
        .def(
            py::init([](const std::filesystem::path& config_path) {
    ...
    clip_text_model.def("get_config", &ov::genai::CLIPTextModel::get_config)
        ...
        .def(
            "compile",
            [](ov::genai::CLIPTextModel& self, const std::string& device, const py::kwargs& kwargs) {
...
void init_clip_text_model_with_projection(py::module_& m) {
    py::class_<ov::genai::CLIPTextModelWithProjection, ov::genai::CLIPTextModel>(
        m,
        ...
        .def(
            py::init([](const std::filesystem::path& root_dir, const std::string& device, const py::kwargs& kwargs) {
                ScopedVar env_manager(pyutils::ov_tokenizers_module_path());
                return std::make_unique<ov::genai::CLIPTextModelWithProjection>(
                    root_dir,
                    device,
                    pyutils::kwargs_to_any_map(kwargs)
                );
        ...
        .def(
            py::init([](const ov::genai::CLIPTextModelWithProjection& model) {
...
void init_t5_encoder_model(py::module_& m) {
    auto t5_encoder_model =
        py::class_<ov::genai::T5EncoderModel>(m, "T5EncoderModel", "T5EncoderModel class.")
            .def(
                py::init([](const std::filesystem::path& root_dir) {
                    ScopedVar env_manager(pyutils::ov_tokenizers_module_path());
            ...
            .def(
                py::init(
                    [](const std::filesystem::path& root_dir, const std::string& device, const py::kwargs& kwargs) {
                        ScopedVar env_manager(pyutils::ov_tokenizers_module_path());
                        return std::make_unique<ov::genai::T5EncoderModel>(
                            root_dir,
                            device,
                            pyutils::kwargs_to_any_map(kwargs)
                        );
            ...
            .def(
                py::init([](const ov::genai::T5EncoderModel& model) {
            ...
            .def(
                "compile",
                [](ov::genai::T5EncoderModel& self, const std::string& device, const py::kwargs& kwargs) {
                    auto map = pyutils::kwargs_to_any_map(kwargs);
                    {
                        py::gil_scoped_release rel;
                        self.compile(device, map);
...
void init_unet2d_condition_model(py::module_& m) {
    auto unet2d_condition_model =
        py::class_<ov::genai::UNet2DConditionModel>(m, "UNet2DConditionModel", "UNet2DConditionModel class.")
            .def(
                py::init([](const std::filesystem::path& root_dir) {
            ...
            .def(
                py::init(
                    [](const std::filesystem::path& root_dir, const std::string& device, const py::kwargs& kwargs) {
                        return std::make_unique<ov::genai::UNet2DConditionModel>(
                            root_dir,
                            device,
                            pyutils::kwargs_to_any_map(kwargs)
                        );
            ...
            .def(
                py::init([](const ov::genai::UNet2DConditionModel& model) {
    ...
    py::class_<ov::genai::UNet2DConditionModel::Config>(
        unet2d_condition_model,
        "Config",
    ...
    unet2d_condition_model.def("get_config", &ov::genai::UNet2DConditionModel::get_config)
        .def(
            "reshape",
            &ov::genai::UNet2DConditionModel::reshape,
            py::arg("batch_size"),
            py::arg("height"),
            py::arg("width"),
        ...
        .def(
            "set_hidden_states",
            &ov::genai::UNet2DConditionModel::set_hidden_states,
            py::arg("tensor_name"),
            py::arg("encoder_hidden_states")
        )
        .def(
            "do_classifier_free_guidance",
            &ov::genai::UNet2DConditionModel::do_classifier_free_guidance,
            py::arg("guidance_scale")
        )
        .def(
            "compile",
            [](ov::genai::UNet2DConditionModel& self, const std::string& device, const py::kwargs& kwargs) {
                auto map = pyutils::kwargs_to_any_map(kwargs);
                {
                    py::gil_scoped_release rel;
                    self.compile(device, map);
...
void init_sd3_transformer_2d_model(py::module_& m) {
    auto sd3_transformer_2d_model =
        py::class_<ov::genai::SD3Transformer2DModel>(m, "SD3Transformer2DModel", "SD3Transformer2DModel class.")
            .def(
                py::init([](const std::filesystem::path& root_dir) {
            ...
            .def(
                py::init(
                    [](const std::filesystem::path& root_dir, const std::string& device, const py::kwargs& kwargs) {
                        return std::make_unique<ov::genai::SD3Transformer2DModel>(
                            root_dir,
                            device,
                            pyutils::kwargs_to_any_map(kwargs)
                        );
            ...
            .def(
                py::init([](const ov::genai::SD3Transformer2DModel& model) {
    ...
    py::class_<ov::genai::SD3Transformer2DModel::Config>(
        sd3_transformer_2d_model,
        "Config",
    ...
    sd3_transformer_2d_model.def("get_config", &ov::genai::SD3Transformer2DModel::get_config)
        .def(
            "reshape",
            &ov::genai::SD3Transformer2DModel::reshape,
            py::arg("batch_size"),
            py::arg("height"),
            py::arg("width"),
            py::arg("tokenizer_model_max_length")
        ...
        .def(
            "set_hidden_states",
            &ov::genai::SD3Transformer2DModel::set_hidden_states,
            py::arg("tensor_name"),
            py::arg("encoder_hidden_states")
        )
        .def(
            "compile",
            [](ov::genai::SD3Transformer2DModel& self, const std::string& device, const py::kwargs& kwargs) {
                auto map = pyutils::kwargs_to_any_map(kwargs);
                {
                    py::gil_scoped_release rel;
                    self.compile(device, map);
...
void init_flux_transformer_2d_model(py::module_& m) {
    auto flux_transformer_2d_model =
        py::class_<ov::genai::FluxTransformer2DModel>(m, "FluxTransformer2DModel", "FluxTransformer2DModel class.")
            .def(
                py::init([](const std::filesystem::path& root_dir) {
            ...
            .def(
                py::init(
                    [](const std::filesystem::path& root_dir, const std::string& device, const py::kwargs& kwargs) {
                        return std::make_unique<ov::genai::FluxTransformer2DModel>(
                            root_dir,
                            device,
                            pyutils::kwargs_to_any_map(kwargs)
                        );
            ...
            .def(
                py::init([](const ov::genai::FluxTransformer2DModel& model) {
    ...
    py::class_<ov::genai::FluxTransformer2DModel::Config>(
    ...
    flux_transformer_2d_model.def("get_config", &ov::genai::FluxTransformer2DModel::get_config)
        .def(
            "reshape",
            &ov::genai::FluxTransformer2DModel::reshape,
            py::arg("batch_size"),
            py::arg("height"),
            py::arg("width"),
            py::arg("tokenizer_model_max_length")
        ...
        .def(
            "set_hidden_states",
            &ov::genai::FluxTransformer2DModel::set_hidden_states,
            py::arg("tensor_name"),
            py::arg("encoder_hidden_states")
        )
        .def(
            "compile",
            [](ov::genai::FluxTransformer2DModel& self, const std::string& device, const py::kwargs& kwargs) {
                auto map = pyutils::kwargs_to_any_map(kwargs);
                {
                    py::gil_scoped_release rel;
                    self.compile(device, map);
...
void init_autoencoder_kl(py::module_& m) {
    auto autoencoder_kl =
        py::class_<ov::genai::AutoencoderKL>(m, "AutoencoderKL", "AutoencoderKL class.")
            .def(
                py::init([](const std::filesystem::path& vae_decoder_path) {
                    return std::make_unique<ov::genai::AutoencoderKL>(vae_decoder_path);
                }),
                py::arg("vae_decoder_path"),
                "VAE decoder directory",
                R"(
            ...
            .def(
                py::init([](const std::filesystem::path& vae_encoder_path,
            ...
            .def(
                py::init([](const std::filesystem::path& vae_decoder_path,
                            const std::string& device,
                            const py::kwargs& kwargs) {
                    return std::make_unique<ov::genai::AutoencoderKL>(
                        vae_decoder_path,
                        device,
                        pyutils::kwargs_to_any_map(kwargs)
                    );
            ...
            .def(
                py::init([](const ov::genai::AutoencoderKL& model) {
    ...
    py::class_<ov::genai::AutoencoderKL::Config>(
        autoencoder_kl,
        "Config",
    ...
    autoencoder_kl
        ...
        .def(
            "compile",
            [](ov::genai::AutoencoderKL& self, const std::string& device, const py::kwargs& kwargs) {
                auto map = pyutils::kwargs_to_any_map(kwargs);
                {
                    py::gil_scoped_release rel;
                    self.compile(device, map);
