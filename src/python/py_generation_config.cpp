...
std::vector<StructuredOutputConfig::StructuralTag> collect_structural_tags(py::iterable elements, const char* context) {
    std::vector<StructuredOutputConfig::StructuralTag> tags;
    for (py::handle element : elements) {
        tags.emplace_back(pyutils::py_obj_to_structural_tag(py::reinterpret_borrow<py::object>(element)));
    }
    if (tags.size() < 2) {
...
void init_generation_config(py::module_& m) {
    ...
    py::class_<StructuralTagItem>(m, "StructuralTagItem", structured_tags_item_docstring)
        ...
        .def("__repr__", [](const StructuralTagItem& self) {
    ...
    py::class_<StructuralTagsConfig>(m, "StructuralTagsConfig", structured_tags_config_docstring)
        ...
        .def_readwrite(
            "structural_tags",
            &StructuralTagsConfig::structural_tags,
            "List of structural tag items for structured output generation"
        )
        .def_readwrite(
            "triggers",
            &StructuralTagsConfig::triggers,
            "List of strings that will trigger generation of structured output"
        )
        .def("__repr__", [](const StructuralTagsConfig& self) {
            return "StructuralTagsConfig(structural_tags=" +
                   py::repr(py::cast(self.structural_tags)).cast<std::string>() +
    ...
    auto structured_output_config =
        py::class_<StructuredOutputConfig>(m, "StructuredOutputConfig", structured_output_config_docstring);
    auto concat = py::class_<StructuredOutputConfig::Concat, std::shared_ptr<StructuredOutputConfig::Concat>>(
        structured_output_config,
        "Concat",
        concat_docstring
    );
    auto union_ = py::class_<StructuredOutputConfig::Union, std::shared_ptr<StructuredOutputConfig::Union>>(
        structured_output_config,
        "Union",
        union_docstring
    );
    auto tag = py::class_<StructuredOutputConfig::Tag, std::shared_ptr<StructuredOutputConfig::Tag>>(
        structured_output_config,
        "Tag",
        tag_docstring
    );
    auto triggered_tags =
        py::class_<StructuredOutputConfig::TriggeredTags, std::shared_ptr<StructuredOutputConfig::TriggeredTags>>(
            structured_output_config,
            "TriggeredTags",
            triggered_tags_docstring
        );
    auto tags_with_separator = py::
        class_<StructuredOutputConfig::TagsWithSeparator, std::shared_ptr<StructuredOutputConfig::TagsWithSeparator>>(
            structured_output_config,
            "TagsWithSeparator",
            tags_with_separator_docstring
        );
    ...
    auto regex = py::class_<StructuredOutputConfig::Regex>(structured_output_config, "Regex", regex_docstring)
                     ...
                     .def("__repr__", [](const StructuredOutputConfig::Regex& self) {
                         return self.to_string();
                     });
    add_grammar_operators(regex);

    auto json_schema =
        py::class_<StructuredOutputConfig::JSONSchema>(structured_output_config, "JSONSchema", jsonschema_docstring)
            .def(py::init<const std::string&>())
            .def_readwrite("value", &StructuredOutputConfig::JSONSchema::value)
            .def("__repr__", [](const StructuredOutputConfig::JSONSchema& self) {
                return self.to_string();
            });
    ...
    auto ebnf = py::class_<StructuredOutputConfig::EBNF>(structured_output_config, "EBNF", ebnf_docstring)
                    ...
                    .def("__repr__", [](const StructuredOutputConfig::EBNF& self) {
                        return self.to_string();
                    });
    add_grammar_operators(ebnf);

    auto const_string =
        py::class_<StructuredOutputConfig::ConstString>(structured_output_config, "ConstString", conststring_docstring)
            .def(py::init<const std::string&>())
            .def_readwrite("value", &StructuredOutputConfig::ConstString::value)
            .def("__repr__", [](const StructuredOutputConfig::ConstString& self) {
                return self.to_string();
            });
    ...
    auto any_text = py::class_<StructuredOutputConfig::AnyText>(structured_output_config, "AnyText", anytext_docstring)
                        .def(py::init<>())
                        .def("__repr__", [](const StructuredOutputConfig::AnyText& self) {
                            return self.to_string();
                        });
    add_grammar_operators(any_text);

    auto qwen_xml = py::class_<StructuredOutputConfig::QwenXMLParametersFormat>(
                        structured_output_config,
                        ...
                        .def("__repr__", [](const StructuredOutputConfig::QwenXMLParametersFormat& self) {
                            return self.to_string();
                        });
    ...
    concat
        ...
        .def(py::init([](py::args args) {
            return std::make_shared<StructuredOutputConfig::Concat>(
                collect_structural_tags(py::reinterpret_borrow<py::iterable>(args), "StructuredOutputConfig.Concat")
            );
        }))
        .def_readwrite("elements", &StructuredOutputConfig::Concat::elements)
        .def("__repr__", [](const StructuredOutputConfig::Concat& self) {
            return self.to_string();
        });
    ...
    union_
        ...
        .def(py::init([](py::args args) {
            return std::make_shared<StructuredOutputConfig::Union>(
                collect_structural_tags(py::reinterpret_borrow<py::iterable>(args), "StructuredOutputConfig.Union")
            );
        }))
        .def_readwrite("elements", &StructuredOutputConfig::Union::elements)
        .def("__repr__", [](const StructuredOutputConfig::Union& self) {
            return self.to_string();
        });
    add_grammar_operators(union_);

    tag.def(
           py::init<const std::string&, StructuredOutputConfig::StructuralTag, const std::string&>(),
           py::arg("begin"),
           py::arg("content"),
           py::arg("end")
    )
        ...
        .def("__repr__", [](const StructuredOutputConfig::Tag& self) {
            return self.to_string();
        });
    ...
    triggered_tags
        .def(
            py::init<const std::vector<std::string>&, const std::vector<StructuredOutputConfig::Tag>&, bool, bool>(),
            py::arg("triggers"),
            py::arg("tags"),
            py::arg("at_least_one") = false,
        ...
        .def("__repr__", [](const StructuredOutputConfig::TriggeredTags& self) {
            return self.to_string();
        });
    ...
    tags_with_separator
        .def(
            py::init<const std::vector<StructuredOutputConfig::Tag>&, const std::string&, bool, bool>(),
            py::arg("tags"),
            py::arg("separator"),
            py::arg("at_least_one") = false,
            py::arg("stop_after_first") = false
        ...
        .def("__repr__", [](const StructuredOutputConfig::TagsWithSeparator& self) {
            return self.to_string();
        });
    add_grammar_operators(tags_with_separator);

    structured_output_config.def(py::init<>())
        .def(py::init([](py::kwargs kwargs) {
            return StructuredOutputConfig(pyutils::kwargs_to_any_map(kwargs));
        }))
        .def_readwrite(
            "json_schema",
            &StructuredOutputConfig::json_schema,
        ...
        .def_property(
            ...
            [](StructuredOutputConfig& self, py::object value) {
                if (value.is_none()) {
                    ...
                    py::isinstance<StructuredOutputConfig::Regex>(value) ||
                    py::isinstance<StructuredOutputConfig::EBNF>(value) ||
                    py::isinstance<StructuredOutputConfig::JSONSchema>(value) ||
                    py::isinstance<StructuredOutputConfig::ConstString>(value) || py::isinstance<py::str>(value) ||
                    ...
                    throw py::type_error(
                        "structural_tags_config must be either StructuralTagsConfig or a StructuralTag (Regex, "
                        "JSONSchema, EBNF, ConstString, AnyText, QwenXMLParametersFormat, Union, Concat, Tag, "
                        "TriggeredTags, TagsWithSeparator or plain str)"
                    );
                }
            },
            "Configuration for structural tags in structured output generation (can be StructuralTagsConfig or "
            "StructuralTag)"
        )
        .def_readwrite(
            "compound_grammar",
            &StructuredOutputConfig::compound_grammar,
            "Compound grammar for structured output generation"
        )
        .def("__repr__", [](const StructuredOutputConfig& self) {
