...
void init_generation_config(py::module_& m) {
    ...
    py::class_<GenerationConfig>(m, "GenerationConfig", generation_config_docstring)
        ...
        .def_readwrite("return_audio", &GenerationConfig::return_audio)
        .def_readwrite("speaker", &GenerationConfig::speaker)
        .def_readwrite("audio_chunk_frames", &GenerationConfig::audio_chunk_frames)
