...
void init_generation_config(py::module_& m) {
    ...
    auto union_ = py::class_<StructuredOutputConfig::Union, std::shared_ptr<StructuredOutputConfig::Union>>(
        ...
        union_docstring);
    auto tag =
        py::class_<StructuredOutputConfig::Tag, std::shared_ptr<StructuredOutputConfig::Tag>>(structured_output_config,
                                                                                              "Tag",
                                                                                              tag_docstring);
    auto triggered_tags =
    ...
    auto tags_with_separator =
        py::class_<StructuredOutputConfig::TagsWithSeparator,
                   std::shared_ptr<StructuredOutputConfig::TagsWithSeparator>>(structured_output_config,
                                                                               "TagsWithSeparator",
    ...
    auto qwen_xml = py::class_<StructuredOutputConfig::QwenXMLParametersFormat>(structured_output_config,
    ...
    tag.def(py::init<const std::string&, StructuredOutputConfig::StructuralTag, const std::string&>(),
            py::arg("begin"),
            py::arg("content"),
            py::arg("end"))
    ...
    structured_output_config.def(py::init<>())
        ...
        .def_property(
            ...
            [](StructuredOutputConfig& self, py::object value) {
                if (value.is_none()) {
                    ...
                    self.structural_tags_config = py::cast<StructuralTagsConfig>(value);
                           ...
                           py::isinstance<py::str>(value) || py::isinstance<StructuredOutputConfig::AnyText>(value) ||
            ...
            "StructuralTag)")
        .def_readwrite("compound_grammar",
