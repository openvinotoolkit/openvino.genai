...
void init_generation_config(py::module_& m) {
    ...
    py::class_<GenerationConfig>(m, "GenerationConfig", generation_config_docstring)
        ...
        .def_readwrite("visual_tokens_retain_percentage", &GenerationConfig::visual_tokens_retain_percentage)
        ...
        .def_readwrite("use_ops_model", &GenerationConfig::use_ops_model)
