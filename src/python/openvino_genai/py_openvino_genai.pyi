...
class WhisperPipeline:
    ...
    def __init__(self, models_path: os.PathLike, device: str, **kwargs) -> None:
        ...
        """
    @typing.overload
    def generate(self, raw_speech_input: list[float], generation_config: WhisperGenerationConfig | None = None, streamer: typing.Callable[[str], bool] | StreamerBase | None = None, **kwargs) -> WhisperDecodedResults:
        """
