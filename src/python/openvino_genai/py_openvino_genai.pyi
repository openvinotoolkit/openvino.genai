...
class ContinuousBatchingPipeline:
    ...
    def add_request(self, request_id: int, prompt: str, generation_config: GenerationConfig) -> GenerationHandle:
        ...
    def generate(self, inputs: list[openvino._pyopenvino.Tensor] | list[str], generation_config: list[GenerationConfig], streamer: typing.Callable[[str], bool] | StreamerBase | None = None) -> list[EncodedGenerationResult] | list[GenerationResult]:
        ...
