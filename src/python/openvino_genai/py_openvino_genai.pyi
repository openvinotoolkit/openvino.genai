...
class ContinuousBatchingPipeline:
    ...
    def add_request(self, request_id: int, prompt: str, generation_config: GenerationConfig) -> GenerationHandle:
        ...
    @typing.overload
    def generate(self, input_ids: list[...], generation_config: list[GenerationConfig], streamer: typing.Callable[[str], bool] | StreamerBase | None = None) -> list[EncodedGenerationResult]:
        ...
    @typing.overload
...
class LLMPipeline:
    ...
    """
    def __call__(self, inputs: ... | TokenizedInputs | str | list[str], generation_config: GenerationConfig | None = None, streamer: typing.Callable[[str], bool] | StreamerBase | None = None, **kwargs) -> EncodedResults | DecodedResults:
        """
    ...
    def finish_chat(self) -> None:
        ...
    def generate(self, inputs: ... | TokenizedInputs | str | list[str], generation_config: GenerationConfig | None = None, streamer: typing.Callable[[str], bool] | StreamerBase | None = None, **kwargs) -> EncodedResults | DecodedResults:
        """
            Generates sequences or tokens for LLMs. If input is a string or list of strings then resulting sequences will be already detokenized.
...
class VLMPipeline:
    ...
    def finish_chat(self) -> None:
        ...
    @typing.overload
    def generate(self, prompt: str, images: list[...], generation_config: GenerationConfig, streamer: typing.Callable[[str], bool] | StreamerBase | None = None, **kwargs) -> VLMDecodedResults:
        """
        ...
        """
    @typing.overload
    def generate(self, prompt: str, images: ..., generation_config: GenerationConfig, streamer: typing.Callable[[str], bool] | StreamerBase | None = None, **kwargs) -> VLMDecodedResults:
        """
            Generates sequences for VLMs.
