...
void init_lora_adapter(py::module_& m) {
    py::class_<ov::genai::Adapter>(
        ...
        .def(py::init<>())
        .def(
            py::init([](const std::filesystem::path& path) {
        ...
        .def(
            py::init([](const ov::Tensor& safetensor) {
    ...
    adapter_config.def(
        py::init([](ov::genai::AdapterConfig::Mode mode) {
    ...
    adapter_config.def(
        py::init([](const ov::genai::Adapter& adapter, ov::genai::AdapterConfig::Mode mode) {
    ...
    adapter_config.def(
        py::init([](const std::vector<std::pair<ov::genai::Adapter, float>>& adapters,
    ...
    adapter_config
        .def("set_adapters_and_alphas", &ov::genai::AdapterConfig::set_adapters_and_alphas, py::arg("adapters"));
}
