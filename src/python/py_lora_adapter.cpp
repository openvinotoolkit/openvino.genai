...
void init_lora_adapter(py::module_& m) {
    py::class_<ov::genai::Adapter>(
        ...
        .def(py::init([](const ov::Tensor& safetensor) {
                 return ov::genai::Adapter(safetensor);
             }),
             py::arg("safetensor"),
             "ov::Tensor with pre-read LoRA Adapter safetensor",
             R"(
            Immutable LoRA Adapter that carries the adaptation matrices and serves as unique adapter identifier.
            safetensor (ov.Tensor): Pre-read LoRA Adapter safetensor.
        )")
        .def("__bool__", [](ov::genai::Adapter& self) {
            return bool(self);
        });

    auto adapter_config = py::class_<ov::genai::AdapterConfig>(
        m,
        "AdapterConfig",
    ...
    adapter_config.def(py::init([](ov::genai::AdapterConfig::Mode mode) {
    ...
    adapter_config.def(
        py::init([](const ov::genai::Adapter& adapter, float alpha, ov::genai::AdapterConfig::Mode mode) {
    ...
    adapter_config.def(py::init([](const ov::genai::Adapter& adapter, ov::genai::AdapterConfig::Mode mode) {
    ...
    adapter_config.def(
        py::init([](const std::vector<ov::genai::Adapter>& adapters, ov::genai::AdapterConfig::Mode mode) {
            return std::make_unique<ov::genai::AdapterConfig>(adapters, mode);
        }),
        py::arg("adapters"),
        py::arg_v("mode", ov::genai::AdapterConfig::Mode::MODE_AUTO, "AdapterConfig.Mode.MODE_AUTO"));

    adapter_config.def(py::init([](const std::vector<std::pair<ov::genai::Adapter, float>>& adapters,
                                   ov::genai::AdapterConfig::Mode mode) {
                           return std::make_unique<ov::genai::AdapterConfig>(adapters, mode);
                       }),
                       py::arg("adapters"),
                       py::arg_v("mode", ov::genai::AdapterConfig::Mode::MODE_AUTO, "AdapterConfig.Mode.MODE_AUTO"));
    adapter_config.def("__bool__", [](ov::genai::AdapterConfig& self) {
        return bool(self);
    });
    ...
    adapter_config.def(
        "add",
        static_cast<ov::genai::AdapterConfig& (ov::genai::AdapterConfig::*)(const ov::genai::Adapter&, float)>(
            &ov::genai::AdapterConfig::add),
        py::arg("adapter"),
        py::arg("alpha"));
    adapter_config.def("add",
                       static_cast<ov::genai::AdapterConfig& (ov::genai::AdapterConfig::*)(const ov::genai::Adapter&)>(
                           &ov::genai::AdapterConfig::add),
                       py::arg("adapter"));
    adapter_config.def("get_adapters_and_alphas", &ov::genai::AdapterConfig::get_adapters_and_alphas);
    adapter_config.def("set_adapters_and_alphas",
                       &ov::genai::AdapterConfig::set_adapters_and_alphas,
                       py::arg("adapters"));
}
