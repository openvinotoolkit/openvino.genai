...
public:
    ...
    std::shared_ptr<DiffusionPipeline> clone() override {
        ...
        std::shared_ptr<StableDiffusionXLPipeline> pipeline =
            std::make_shared<StableDiffusionXLPipeline>(m_pipeline_type,
                                                        *clip_text_encoder,
    ...
    void compute_hidden_states(const std::string& positive_prompt,
        ...
        if (compute_negative_prompt) {
            ...
            ov::Shape encoder_hidden_states_shape = {ehs_1_shape[0] * batch_size_multiplier,
                                                     ehs_1_shape[1],
            ...
            std::copy_n(add_text_embeds_positive.data<float>(),
        ...
        if (generation_config.num_images_per_prompt == 1) {
            ...
            for (size_t n = 0; n < generation_config.num_images_per_prompt; ++n) {
                ...
                if (batch_size_multiplier > 1) {
                    numpy_utils::batch_copy(add_text_embeds,
            ...
            for (size_t n = 0; n < generation_config.num_images_per_prompt; ++n) {
                ...
                if (batch_size_multiplier > 1) {
                    numpy_utils::batch_copy(add_time_ids,
...
private:
    ...
    utils::SharedOptional<const ov::AnyMap> properties_for_text_encoder(const ov::AnyMap& properties,
