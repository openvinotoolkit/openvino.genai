...
void ImageProcessor::merge_image_preprocessing(std::shared_ptr<ov::Model> model,
                                               bool do_normalize,
                                               bool do_binarize,
...
ImageResizer::ImageResizer(const std::string& device,
    ...
    auto resize_model = std::make_shared<ov::Model>(ov::ResultVector{result},
