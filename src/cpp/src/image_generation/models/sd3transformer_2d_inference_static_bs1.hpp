...
public:
    ...
    InferenceStaticBS1(InferenceStaticBS1& other)
        : Inference(other), m_native_batch_size(other.m_native_batch_size) {
    ...
    virtual std::shared_ptr<Inference> clone() override {
        ...
        return std::make_shared<InferenceStaticBS1>(*this);
    }
