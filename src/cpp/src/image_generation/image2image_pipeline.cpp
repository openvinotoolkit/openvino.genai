...
Image2ImagePipeline Image2ImagePipeline::flux(
    ...
    auto impl = std::make_shared<FluxPipeline>(
        PipelineType::IMAGE_2_IMAGE,
        clip_text_model,
        t5_encoder_model,
        transformer,
...
void Image2ImagePipeline::reshape(
...
void Image2ImagePipeline::compile(
...
ov::Tensor Image2ImagePipeline::generate(
