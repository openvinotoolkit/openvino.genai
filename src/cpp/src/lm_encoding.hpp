...
ov::genai::utils::GenerationFinishInfo get_lm_encoded_results(ov::InferRequest& m_llm, const ov::Tensor& input_ids, const ov::Tensor& attention_mask,
                                                              ...
                                                              std::optional<ov::Tensor> position_ids, std::optional<ov::Tensor> token_type_ids, std::optional<ov::Tensor> cross_attention_mask,
                                                              utils::KVCacheState& m_kv_cache_state, EmbeddingsModel::Ptr m_embedding,
