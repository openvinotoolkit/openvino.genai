...
ov::Output<ov::Node> make_rms_norm_qwen3(const std::string& key,
...
// There are q_norm k_norm in Qwen3, if key_name + ".self_attn.q_norm" + ".weight" exists, a rms_norm will be built, if
// not it will go to else branch.
