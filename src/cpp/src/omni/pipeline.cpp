...
OmniPipeline::OmniPipeline(const std::shared_ptr<VLMPipeline::VLMBackend>& vlm,
...
std::shared_ptr<VLMPipeline::VLMBackend> OmniPipeline::get_vlm() const {
