...
public:
    LogitProcessor(
        ...
        if (sampling_params.min_new_tokens > 0) {
            m_logit_transformers.emplace_back(new LogitTransformers::EOSPenaltyTransform(
        ...
        OPENVINO_ASSERT(
            structured_output_controller != nullptr || !sampling_params.is_structured_output_generation(),
