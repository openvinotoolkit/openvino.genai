...
inline bool is_stop_token_id_hit_in_sequence_group(SequenceGroup::Ptr sequence_group,
...
class Sampler {
    ...
    SequenceGroupSamplingInfo sample_from_sequence_group(SequenceGroup::Ptr sequence_group,
...
public:
    ...
    void create_logit_processor(uint64_t request_id,
...
public:
    ...
    void select_next_tokens(const ov::Tensor& logits,
                            SamplerOutput& sampler_output,
                            const std::pair<size_t, std::set<std::string>>& stop_strings);
