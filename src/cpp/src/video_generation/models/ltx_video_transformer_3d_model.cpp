...
LTXVideoTransformer3DModel& LTXVideoTransformer3DModel::compile(const std::string& device,
                                                                const ov::AnyMap& properties) {
...
void LTXVideoTransformer3DModel::set_hidden_states(const std::string& tensor_name,
