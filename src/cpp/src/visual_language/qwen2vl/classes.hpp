...
protected:
     ...
     */
    void encode_frames_with_config(EncodedVideo& encoded_video,
...
public:
    InputsEmbedderQwen2VL(const VLMConfig& vlm_config,
...
protected:
    ...
    virtual void expand_video_tags_in_prompt(std::string& unified_prompt,
