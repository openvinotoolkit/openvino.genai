...
void merge_text_and_image_embeddings_nanollava(
...
NormalizedPrompt InputsEmbedderNanoLLaVA::normalize_prompt(
...
ov::Tensor InputsEmbedderNanoLLaVA::get_inputs_embeds(
...
ov::Tensor
InputsEmbedderNanoLLaVA::apply_chat_template_tokenize(const std::string& prompt, ov::genai::VLMPerfMetrics& metrics) {
