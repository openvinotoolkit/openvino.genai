...
public:
    ...
    const std::vector<MessageMetadata>& get_messages_metadata() const {
        return m_messages_metadata;
    }
    std::vector<MessageMetadata>& get_messages_metadata() {
        return m_messages_metadata;
    }
    ...
    VisionID get_image_vision_id(size_t index) const {
        return m_image_index_to_id.at(index);
    }
    VisionID get_video_vision_id(size_t index) const {
        return m_video_index_to_id.at(index);
    }

    size_t get_base_image_index() const {
        return m_image_index_to_id.size();
    }
    size_t get_base_video_index() const {
        return m_video_index_to_id.size();
    }
    ...
    ResolvedVisions resolve_visions_with_sequence(
        ...
        std::optional<const std::vector<size_t>> video_sequence = std::nullopt) const;
    ...
    ChatHistoryFormat get_chat_history_format() {
        return m_chat_history_format;
    }

    size_t get_last_user_message_index() const {
        return m_last_user_message_index;
    }
