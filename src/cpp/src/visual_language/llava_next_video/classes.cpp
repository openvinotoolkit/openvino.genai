...
VisionEncoderLLaVANextVideo::VisionEncoderLLaVANextVideo(
    ...
    auto compiled_model = utils::singleton_core().compile_model(
        ...
        utils::get_model_properties(properties, "multi_modal_projector"));
    ...
    compiled_model = utils::singleton_core().compile_model(
        ...
        utils::get_model_properties(properties, "resampler"));
...
VisionEncoderLLaVANextVideo::VisionEncoderLLaVANextVideo(
    ...
    if (use_ov_vision_preprocess) {
        ...
        auto compiled_model = utils::singleton_core().compile_model(
            model, device, utils::get_model_properties(device_config, "vision_embeddings"));
        // Overwrite vision encoder queue with integrated model
        m_ireq_queue_vision_encoder = std::make_unique<CircularBufferQueue<ov::InferRequest>>(
            compiled_model.get_property(ov::optimal_number_of_infer_requests),
            [&compiled_model]() -> ov::InferRequest {
    ...
    auto compiled_model = utils::singleton_core().compile_model(
        ...
        utils::get_model_properties(device_config, "resampler"));
    ...
    compiled_model = utils::singleton_core().compile_model(
        ...
        utils::get_model_properties(device_config, "multi_modal_projector"));
