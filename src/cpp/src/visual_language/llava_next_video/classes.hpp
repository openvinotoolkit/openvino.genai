...
public:
    ...
    std::pair<std::vector<ov::Tensor>, size_t> preprocess_frames_cpp(const std::vector<ov::Tensor>& frames);
    
    std::pair<std::vector<ov::Tensor>, size_t> preprocess_frames_ov(const std::vector<ov::Tensor>& frames);
