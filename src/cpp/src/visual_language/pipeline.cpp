...
public:
    ...
    VLMDecodedResults generate(
        ...
        size_t generated_via_attention_mask = m_language.get_tensor("attention_mask").get_shape()[1] - attention_mask_size;
        m_inputs_embedder->update_tokenized_history(finish_info, prev_tokenized_history, generation_config.is_beam_search(), m_language.get_tensor("attention_mask").get_shape()[1] - (history_size + inputs_embeds_size), inputs_embeds_size);
