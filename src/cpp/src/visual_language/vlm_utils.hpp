...
// and vision-token pruning performed while producing the corresponding embeddings.
inline ov::Tensor extract_prompt_ids(const std::vector<int64_t>& cache_ids,
                                     size_t cache_size_before,
                                     size_t expected_prompt_size) {
