...
namespace ov::genai {
WhisperScaledDotProductAttentionDecomposition::WhisperScaledDotProductAttentionDecomposition() {
    auto pattern_node = ov::pass::pattern::wrap_type<ov::op::v13::ScaledDotProductAttention>();

    matcher_pass_callback callback = [this, pattern_node](ov::pass::pattern::Matcher& m) {
