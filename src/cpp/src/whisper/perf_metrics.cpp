...
WhisperPerfMetrics WhisperPerfMetrics::operator+(const WhisperPerfMetrics& right) const {
    ...
    const auto& right_encode_inference_durations = right.whisper_raw_metrics.encode_inference_durations;
    ...
    const auto& right_decode_inference_durations = right.whisper_raw_metrics.decode_inference_durations;
