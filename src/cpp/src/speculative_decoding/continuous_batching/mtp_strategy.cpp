...
GenerationHandle ContinuousBatchingPipeline::MtpDecodingImpl::add_request(
    ...
    try {
        ...
        auto main_handle = m_main_pipeline->add_request(request_id, input_ids, sampling_params, token_type_ids, prompt_ids, lm_extra_inputs);
...
GenerationHandle ContinuousBatchingPipeline::MtpDecodingImpl::add_request(
    ...
    return add_request(request_id, inputs_embeds, sampling_params, token_type_ids, prompt_ids,
