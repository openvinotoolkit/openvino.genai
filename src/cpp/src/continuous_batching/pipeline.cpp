...
ContinuousBatchingPipeline::ContinuousBatchingPipeline( const std::filesystem::path& models_path,
    ...
    auto [properties_without_draft_model_without_gguf, enable_save_ov_model, save_ov_model_quantize_mode] = utils::extract_gguf_properties(properties_without_draft_model);
