...
public:
    struct Output {
        ...
        size_t m_cache_usage_in_bytes = 0;
    };
    ...
    Output schedule(std::vector<SequenceGroup::Ptr>& sequence_groups) {
        ...
        scheduler_output.m_cache_usage_in_bytes = m_block_manager->get_total_number_of_kv_blocks() * m_cache_manager->get_block_size_in_bytes();
