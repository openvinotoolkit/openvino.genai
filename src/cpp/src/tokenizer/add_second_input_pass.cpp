...
void AddSecondInputPass::insert_splits() {
    ...
    auto second_start = std::make_shared<Minimum>(std::make_shared<Subtract>(total_size, param_2_shape),
    ...
    OutputVector first_input = {std::make_shared<Broadcast>(begins_1, broadcasted_shape),
                                std::make_shared<Broadcast>(ends_1, broadcasted_shape),
                                data};
    OutputVector second_input = {std::make_shared<Broadcast>(begins_2, broadcasted_shape),
