...
private:
    ...
    static ASRDecodedResults to_asr_results(std::vector<WhisperDecodedResults>&& whisper_results) {
        ...
        // Flatten one Whisper sequence per input while preserving input order.
        ...
        // Preserve input indices by inserting empty entries for inputs without chunks or words.
        ...
        // Metrics are aggregate for the batch; convert the first result's copy once.
