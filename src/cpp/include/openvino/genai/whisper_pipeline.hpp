...
public:
     ...
     * For batch sizes greater than one, only short-form greedy decoding on CPU/GPU is supported;
     * streaming and timestamps are not supported. Unsupported configurations are rejected.
     *
