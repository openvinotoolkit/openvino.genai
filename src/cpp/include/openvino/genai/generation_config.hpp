 ...
 * @param choices if set, the output will be one of specified strings.
...
public:
    ...
    bool is_structured_output() const;
...
static constexpr ov::Property<std::string> json{"json"};
static constexpr ov::Property<std::string> regex{"regex"};
static constexpr ov::Property<std::vector<std::string>> choices{"choices"};
