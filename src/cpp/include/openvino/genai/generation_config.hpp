...
public:
    ...
    using StructuralTag = std::variant<std::string,
                                       Regex,
                                       JSONSchema,
                                       EBNF,
                                       ConstString,
...
OPENVINO_GENAI_EXPORTS std::shared_ptr<StructuredOutputConfig::Concat> operator+(
    const StructuredOutputConfig::StructuralTag& lhs,
    const StructuredOutputConfig::StructuralTag& rhs);

OPENVINO_GENAI_EXPORTS std::shared_ptr<StructuredOutputConfig::Union> operator|(
    const StructuredOutputConfig::StructuralTag& lhs,
    const StructuredOutputConfig::StructuralTag& rhs);
