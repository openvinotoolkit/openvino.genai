...
struct OPENVINO_GENAI_EXPORTS SDPerModelsPerfMetrics : public ov::genai::SDPerfMetrics {
    ...
    */
    ...
    /**
    * @param returns the number of draft candidate tokens offered for validation by the main model.
    ...
    */
    ...
    /**
    * @param returns accepted draft candidate tokens divided by draft candidate tokens.
