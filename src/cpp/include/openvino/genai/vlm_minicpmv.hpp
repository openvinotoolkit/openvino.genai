...
OPENVINO_GENAI_EXPORTS std::pair<std::vector<std::vector<ov::Tensor>>, size_t> llava_image_embed_make_with_bytes_slice(struct clip_ctx * ctx_clip, const ov::Tensor& img);
