 ...
 */
OPENVINO_GENAI_C_EXPORTS DecodedResultsHandle* CreateDecodedResults();
 ...
 */
OPENVINO_GENAI_C_EXPORTS void DestroyDecodedResults(DecodedResultsHandle* results);
 ...
 */
OPENVINO_GENAI_C_EXPORTS void DecodedeResultsGetPerfMetrics(DecodedResultsHandle* results, PerfMetricsHandle** metrics);
 ...
 */
OPENVINO_GENAI_C_EXPORTS void DecodeResultsGetString(DecodedResultsHandle* results, char* output, int max_size);
 ...
 */
OPENVINO_GENAI_C_EXPORTS LLMPipelineHandle* CreateLLMPipeline(const char* models_path, const char* device);

/**
 * @brief Release the memory allocated by LLMPipelineHandle.
 * @param model A pointer to the LLMPipelineHandle.
 */
OPENVINO_GENAI_C_EXPORTS void DestroyLLMPipeline(LLMPipelineHandle* pipe);
 ...
 */
OPENVINO_GENAI_C_EXPORTS void LLMPipelineGenerate(LLMPipelineHandle* handle,
                                                  const char* inputs,
                                                  char* output,
                                                  int max_size,
 ...
 */
OPENVINO_GENAI_C_EXPORTS void LLMPipelineGenerateStream(LLMPipelineHandle* pipe,
                                                        const char* inputs,
                                                        char* output,
                                                        int max_size,
                                                        GenerationConfigHandle* config,
 ...
 */
OPENVINO_GENAI_C_EXPORTS DecodedResultsHandle* LLMPipelineGenerateDecodeResults(LLMPipelineHandle* handle,
                                                                                const char* inputs,
                                                                                GenerationConfigHandle* config);
/**
 ...
 * @param pipe A pointer to the LLMPipelineHandle.
 */
OPENVINO_GENAI_C_EXPORTS void LLMPipelineStartChat(LLMPipelineHandle* pipe);

/**
 * @brief Finish chat and clear kv cache.
 * @param pipe A pointer to the LLMPipelineHandle.
 */
OPENVINO_GENAI_C_EXPORTS void LLMPipelineFinishChat(LLMPipelineHandle* pipe);
 ...
 */
OPENVINO_GENAI_C_EXPORTS GenerationConfigHandle* LLMPipelineGetGeneratonConfig(LLMPipelineHandle* pipe);
 ...
 */
OPENVINO_GENAI_C_EXPORTS void LLMPipelineSetGeneratonConfig(LLMPipelineHandle* pipe, GenerationConfigHandle* config);
