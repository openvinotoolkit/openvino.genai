...
describe("Text2VideoPipeline", () => {
    ...
    it("should return performance metrics", async () => {
      ...
      assert.ok(
        typeof metrics.generateDuration === "number",
        "generateDuration should be a number",
      );
      assert.ok(
        typeof metrics.iterationDuration.mean === "number",
        "iterationDuration.mean should be a number",
      );
      assert.ok(
        typeof metrics.iterationDuration.std === "number",
        "iterationDuration.std should be a number",
      );
      assert.ok(
        typeof metrics.transformerInferDuration.mean === "number",
        "transformerInferDuration.mean should be a number",
      );
      assert.ok(
        typeof metrics.vaeDecoderInferDuration === "number",
        "vaeDecoderInferDuration should be a number",
      );
    });
