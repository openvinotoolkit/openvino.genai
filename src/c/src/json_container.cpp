...
ov_genai_json_container_status_e ov_genai_json_container_create_from_json_string(ov_genai_json_container** container,
                                                                                 const char* json_str) {
...
ov_genai_json_container_status_e ov_genai_json_container_to_json_string(const ov_genai_json_container* container,
                                                                        char* output,
                                                                        size_t* output_size) {
...
ov_genai_json_container_status_e ov_genai_json_container_copy(const ov_genai_json_container* source,
