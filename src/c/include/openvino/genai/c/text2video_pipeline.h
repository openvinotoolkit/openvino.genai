...
OV_GENAI_C_API int ov_genai_text2video_pipeline_create(const char* model_path,
                                                       const char* device,
...
OV_GENAI_C_API void ov_genai_text2video_pipeline_generate(ov_genai_text2video_pipeline* pipeline,
                                                          const char* prompt,
