...
seed = 42
generator = torch.Generator(device='cpu').manual_seed(seed)
t = torch.rand([2, 2], generator=generator, dtype=torch.float32)
print(f'random tensor: {t}')

generator = torch.Generator(device='cpu').manual_seed(seed)
t = torch.rand([1, 4, 2, 2], generator=generator, dtype=torch.float32)
print(f'random tensor: {t}')

generator = torch.Generator(device='cpu').manual_seed(seed)
t = torch.rand([1, 3, 2, 2], generator=generator, dtype=torch.float32)
print(f'random tensor: {t}')
