...
./build/llm/cpp/llm open_llama_3b_v2/openvino_model.xml tokenizer.xml detokenizer.xml asdf 25 9 11 early 3 1.0 1.0 0 > ./pred.txt
python3 ./text_generation/llama/cpp/ref.py ./pred.txt ./open_llama_3b_v2/ asdf 25 9 11 early 3 1.0 1.0 0
